class GiftsController < ApplicationController
  ...
  def creating_gifts
    #Chivas Flask
    Gift.create!([type_g: 0, name: 'Chivas Flask', position: 10, event_id: params[:event_id], inventory: params[:gifts][:flask], predicted: params[:gifts][:flask], image: 'g-flask.jpg'])
    ...
    #Chivas 12 años Tin 750ml
      Gift.create!([type_g: 5, name: 'Chivas 12 años Tin 750ml', position: 300, event_id: params[:event_id], inventory: params[:gifts][:tin], predicted: params[:gifts][:tin], priority: 0, image: 'g-tin.jpg'])
