  ...
  def creating_gifts
    ...
    if g.gifts.blank?
      ...
      #type_g: 10 es para los regalos en blanco. Estos deben tener inventario para que funcionen correctamente
        Gift.create!([type_g: 10, name: 'Regalo EN BLANCO', position: 320, event_id: params[:event_id], inventory: 1, predicted:  1, priority: 1])
      ...
      Gift.create!([type_g: 3, name: 'Travel Set', position: 105, event_id: params[:event_id], inventory: params[:gifts][:travel], predicted:  params[:gifts][:travel], priority: 1, image: 'g-travel.png'])
        Gift.create!([type_g: 10, name: 'Regalo EN BLANCO', position: 205, event_id: params[:event_id], inventory: 1, predicted:  1, priority: 1])
